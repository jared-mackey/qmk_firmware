 ...
 * `-----------------------------------------/       /     \      \-----------------------------------------'
 *                   | LAlt | LGUI |LOWER | /BSPC   /       \Enter \  |Space |RAISE | RGUI |
 *                   |      |      |      |/       /         \      \ |      |      |      |
 *                   `----------------------------'           '------''--------------------'
 */
[_NORMAN] = LAYOUT( \
  ...
  KC_ESC,   KC_A,   KC_S,    KC_E,    MT(MOD_LCTL, KC_T), KC_G,          KC_Y,    MT(MOD_RCTL, KC_N),    KC_I,    KC_O,    KC_H, KC_QUOT, \
  KC_LSPO,  KC_Z,   KC_X,    KC_C,    KC_V,    KC_B, KC_LBRC,  KC_RBRC,  KC_P,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH,  KC_RSPC, \
...
[_LOWER] = LAYOUT( \
  ...
  XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,                   XXXXXXX, XXXXXXX, XXXXXXX, KC_LABK, KC_RABK, XXXXXXX,\
  KC_GRV, KC_EXLM, KC_AT,   KC_HASH, KC_DLR,  KC_PERC,                   KC_CIRC, KC_AMPR, KC_ASTR, KC_LPRN, KC_RPRN, KC_TILD, \
  XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_PLUS, KC_MINS, KC_EQL, KC_LBRC, KC_RBRC, KC_PIPE, \
