...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
 [_NORMAN] = LAYOUT(
  ...
  KC_ESC,  KC_A,   KC_S,    KC_E,    MT_T,    KC_G,                     KC_Y,    MT_N,    KC_I,    KC_O,    KC_H,    KC_QUOT,
  SC_LSPO,  KC_Z,   KC_X,    KC_C,    KC_V,    KC_B, TMUX,  KC_MPLY,  KC_P,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH,  SC_RSPC,
                          KC_LALT,    KC_LGUI, RAISE, KC_BSPC,  KC_ENT,   KC_SPC,   LOWER, KC_RGUI
),
/* LOWER
 * ,-----------------------------------------.                    ,-----------------------------------------.
 ...
 */
 ...
 _______, _______, _______, _______, _______, _______,                   KC_PLUS, KC_EQL, KC_MINS,KC_LBRC, KC_RBRC, EPIPE,
